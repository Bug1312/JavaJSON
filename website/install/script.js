...
function addVersion(version, date, changelogURL) {
    ...
    <div class="version">
        ...
        <a class="version-file version-underline" href="https://github.com/${repo}/releases/download/${version}/dm_java_json.js" download="dm_java_json.js"> <i class="bi bi-file-earmark-arrow-down"></i> File </a>
        <div class="tooltip" style="width:initial;">
            ...
            <input id="version_${version}-url-copy" type="text" value="https://github.com/${repo}/releases/download/${version}/dm_java_json.js" readonly hidden>
        </div>
